...
_IntArray: TypeAlias = npt.NDArray[np.int64]
...
class ProblemData:
    def __init__(
        ...
        distance_matrices: list[_IntArray],
        duration_matrices: list[_IntArray],
    ...
    def distance_matrices(self) -> list[_IntArray]: ...
    def duration_matrices(self) -> list[_IntArray]: ...
    def replace(
        self,
        clients: list[Client] | None = None,
        depots: list[Depot] | None = None,
        vehicle_types: list[VehicleType] | None = None,
        distance_matrices: list[_IntArray] | None = None,
        duration_matrices: list[_IntArray] | None = None,
        groups: list[ClientGroup] | None = None,
    ) -> ProblemData: ...
    def group(self, group: int) -> ClientGroup: ...
    def vehicle_type(self, vehicle_type: int) -> VehicleType: ...
    def distance_matrix(self, profile: int) -> _IntArray: ...
    def duration_matrix(self, profile: int) -> _IntArray: ...
