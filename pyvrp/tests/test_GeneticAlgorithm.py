...
@mark.parametrize(
    ...
    [
        (-0.25, 0.5, True, 0),  # repair_probability < 0
        (1.25, 0.5, True, 0),  # repair_probability > 1
        (0.0, 0.5, True, -1),  # nb_iter_no_improvement < 0
        (0.0, -0.25, True, 1),  # intensify_probability < 0
        (0.0, 1.25, True, 1),  # intensify_probability > 1
    ],
)
...
@mark.parametrize(
    ...
    "nb_iter_no_improvement",
    [
        (0.0, 0.5, True, 0),  # nb_iter_no_improvement == 0
        (0.0, 0.5, True, 1),  # repair_probability == 0
        (1.0, 0.5, True, 1),  # repair_probability == 1
        (0.5, 0, True, 1),  # intensify_probability == 0
        (0.5, 1, True, 1),  # intensify_probability == 1
        (0.5, 0.5, False, 1),  # intensify_on_best is False
    ],
)
