...
class RemoveNeighbours(PerturbationOperator): ...
class InsertOptional(PerturbationOperator): ...
...
class LocalSearch:
    ...
    def add_perturbation_operator(self, op: PerturbationOperator) -> None: ...
    @property
    ...
    @num_perturbations.setter
    def num_perturbations(self, num_perturbations: int) -> None: ...
    @property
