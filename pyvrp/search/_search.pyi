...
class Route:
    ...
    def ls(self, idx: int) -> LoadSegment: ...
    def ls_between(self, start: int, end: int) -> LoadSegment: ...
    def ls_before(self, end: int) -> LoadSegment: ...
    def ls_after(self, start: int) -> LoadSegment: ...
    def ds(self, idx: int) -> DurationSegment: ...
    def ds_between(self, start: int, end: int) -> DurationSegment: ...
    def ds_before(self, end: int) -> DurationSegment: ...
    def ds_after(self, start: int) -> DurationSegment: ...
