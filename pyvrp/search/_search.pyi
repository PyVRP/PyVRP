...
class Route:
    ...
    def load_at(
        self, idx: int, dimension: int = 0, trip: int = 0
    ) -> LoadSegment: ...
    def load_between(
        self, start: int, end: int, dimension: int = 0, trip: int = 0
    ) -> LoadSegment: ...
    def load_before(
        self, end: int, dimension: int = 0, trip: int = 0
    ) -> LoadSegment: ...
    def load_after(
        self, start: int, dimension: int = 0, trip: int = 0
    ) -> LoadSegment: ...
