...
_ITERATION = (
    ...
    "{pop_size:>4} {pop_min:>12} {pop_max:>12} {pop_mean:>12.0f}"
)
...
Solving an instance with:
    ...
    Iters    Time |      Current OK    Candidate OK         Best OK | Size       Pop Min      Pop Max     Pop Mean"""
...
class ProgressPrinter:
    ...
    def iteration(self, stats: Statistics):
        ...
        msg = _ITERATION.format(
            ...
            pop_size=datum.pop_size,
            pop_min=datum.pop_min_cost,
            pop_max=datum.pop_max_cost,
            pop_mean=datum.pop_mean_cost,
        )
