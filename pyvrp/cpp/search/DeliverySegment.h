#ifndef PYVRP_SEARCH_DELIVERYSEGMENT_H
#define PYVRP_SEARCH_DELIVERYSEGMENT_H
...
public:
    DeliverySegment(pyvrp::ProblemData const &data, size_t shipment)
...
#endif  // PYVRP_SEARCH_DELIVERYSEGMENT_H
