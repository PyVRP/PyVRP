...
public:
     ...
     *     client's (x, y) location tuple.
     * delivery
     *     The amounts this client demands from the depot, for one or more load
     *     dimensions. Default 0.
     * pickup
     *     The amounts this client ships back to the depot, for one or more load
     *     dimensions. Default 0.
     * service_duration
     ...
     *     Default 1.
     * capacity
     *     Capacity of this vehicle type, for one or more load dimensions. This
     *     is the maximum total delivery or pickup amount (in each dimension)
     *     that the vehicle can store along the route. The values must be
