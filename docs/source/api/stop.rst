...
These can be used to stop the :class:`~pyvrp.IteratedLocalSearch.IteratedLocalSearch` whenever some criterion is met: for example, when some maximum number of iterations or run-time is exceeded.
