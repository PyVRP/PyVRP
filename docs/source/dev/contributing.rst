...
.. md-tab-set::
    ...
    .. md-tab-item:: Linux
        ...
        .. code-block:: shell
            ...
            poetry run perf record bench solve instances/VRPTW/RC2_10_5.vrp --seed 6 --round_func dimacs --max_runtime 5
    ...
    .. md-tab-item:: macOS
        ...
        .. code-block:: shell
            ...
            poetry run bench solve instances/VRPTW/RC2_10_5.vrp --seed 6 --round_func dimacs --max_runtime 60
