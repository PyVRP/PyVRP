...
def test_time_warp_when_there_is_existing_time_warp(existing_time_warp):
    ...
    """
    ds1 = DurationSegment(0, 0, existing_time_warp, 0, 0, 0)
...
def test_merge_two():
    ...
    """
    ds1 = DurationSegment(5, 0, 0, 0, 5, 0)
    ds2 = DurationSegment(0, 0, 5, 3, 6, 0)
    ...
    ds2 = DurationSegment(0, 0, 5, 3, 6, 3)
    merged = DurationSegment.merge(mat[0, 1], ds1, ds2)
...
def test_merging_two_previously_merged_duration_segments():
    ...
    """
    time_warp = 1
    ds1 = DurationSegment(5, 0, time_warp, 0, 5, 0)  # depot
    ds2 = DurationSegment(1, 0, time_warp, 3, 6, 0)  # client 1
...
def test_max_duration_argument():
    ...
    """
    ds = DurationSegment(5, 0, 0, 0, 0, 0)  # five duration
...
def test_bug_fix_overflow_more_timewarp_than_duration():
    ...
    """
    ds1 = DurationSegment(9, 0, 18, 0, 18, 0)
