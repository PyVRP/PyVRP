...
def test_plot_result():
    ...
    """
    data = read("data/RC208.vrp", round_func="trunc")
    bks = read_solution("data/RC208.sol", data)  # cost 757

    stats = Statistics()
    stats.collect(900, True, 800, True, 800, True)
    stats.collect(800, True, 850, True, 800, True)
    stats.collect(850, True, 850, True, 800, True)
    stats.collect(850, True, 776, True, 776, True)
    stats.collect(776, True, 757, True, 757, True)

    res = Result(bks, stats, 5, 0.0)
